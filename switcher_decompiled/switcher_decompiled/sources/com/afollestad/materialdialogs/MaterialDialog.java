...
public class MaterialDialog extends DialogBase implements View.OnClickListener, DefaultRvAdapter.InternalListCallback {
    ...
    final Drawable getListSelector() {
        ...
        Drawable drawableResolveDrawable = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_list_selector);
    ...
    Drawable getButtonSelector(DialogAction dialogAction, boolean z) {
        if (z) {
            ...
            Drawable drawableResolveDrawable = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_btn_stacked_selector);
        ...
        if (i == 1) {
            ...
            Drawable drawableResolveDrawable2 = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_btn_neutral_selector);
        ...
        if (i != 2) {
            ...
            Drawable drawableResolveDrawable4 = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_btn_positive_selector);
        ...
        Drawable drawableResolveDrawable6 = DialogUtils.resolveDrawable(this.builder.context, R.attr.md_btn_negative_selector);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            this.buttonRippleColor = DialogUtils.resolveColor(context, R.attr.md_btn_ripple_color, DialogUtils.resolveColor(context, R.attr.colorControlHighlight, Build.VERSION.SDK_INT >= 21 ? DialogUtils.resolveColor(context, android.R.attr.colorControlHighlight) : 0));
