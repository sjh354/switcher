...
public class MDTintHelper {
    public static void setTint(RadioButton radioButton, ColorStateList colorStateList) {
        ...
        Drawable drawableWrap = DrawableCompat.wrap(ContextCompat.getDrawable(radioButton.getContext(), R.drawable.abc_btn_radio_material));
    ...
    public static void setTint(CheckBox checkBox, ColorStateList colorStateList) {
        ...
        Drawable drawableWrap = DrawableCompat.wrap(ContextCompat.getDrawable(checkBox.getContext(), R.drawable.abc_btn_check_material));
        DrawableCompat.setTintList(drawableWrap, colorStateList);
