...
public class ValueAnimator extends Animator {
    ...
    public ValueAnimator mo135clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo135clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderMo139clone = propertyValuesHolderArr[i2].mo139clone();
                valueAnimator.mValues[i2] = propertyValuesHolderMo139clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderMo139clone.getPropertyName(), propertyValuesHolderMo139clone);
            }
        }
        return valueAnimator;
    }
