...
public final class AnimatorSet extends Animator {
    ...
    public AnimatorSet mo135clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo135clone();
        ...
        for (Node node : this.mNodes) {
            Node nodeM136clone = node.m136clone();
            map.put(node, nodeM136clone);
            animatorSet.mNodes.add(nodeM136clone);
            animatorSet.mNodeMap.put(nodeM136clone.animation, nodeM136clone);
            ArrayList arrayList = null;
            nodeM136clone.dependencies = null;
            nodeM136clone.tmpDependencies = null;
            nodeM136clone.nodeDependents = null;
            nodeM136clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM136clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m136clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo135clone();
                return node;
