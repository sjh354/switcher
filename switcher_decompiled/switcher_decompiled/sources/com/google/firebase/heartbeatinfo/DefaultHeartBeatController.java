...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    /* synthetic */ Void m107x734756b4() throws Exception {
        synchronized (this) {
    ...
    /* synthetic */ String m106x341e14f2() throws Exception {
        String string;
        synchronized (this) {
            ...
            jSONObject2.put(ClientCookie.VERSION_ATTR, RestErrorCode.PHONE_NUMBER_IS_WRONG);
