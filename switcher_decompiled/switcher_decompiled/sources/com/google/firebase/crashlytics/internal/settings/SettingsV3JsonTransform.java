...
class SettingsV3JsonTransform implements SettingsJsonTransform {
    ...
    public Settings buildFromJson(CurrentTimeProvider currentTimeProvider, JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.has(LogContract.Session.SESSION_CONTENT_DIRECTORY)) {
            sessionDataBuildSessionDataFrom = buildSessionDataFrom(jSONObject.getJSONObject(LogContract.Session.SESSION_CONTENT_DIRECTORY));
        } else {
