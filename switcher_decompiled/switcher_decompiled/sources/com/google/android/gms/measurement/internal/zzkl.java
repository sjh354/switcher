...
public final class zzkl extends zzkn {
    ...
    public final void zzd(long j) {
        ...
        this.zzs.zzaw();
        Context contextZzau = this.zzs.zzau();
        if (!zzlh.zzaj(contextZzau)) {
            this.zzs.zzay().zzc().zza("Receiver not registered/enabled");
        }
        if (!zzlh.zzak(contextZzau, false)) {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            if (alarmManager != null) {
                this.zzs.zzf();
                alarmManager.setInexactRepeating(2, jElapsedRealtime, Math.max(((Long) zzeb.zzr.zza(null)).longValue(), j), zzh());
                return;
            }
            return;
        }
        ...
        persistableBundle.putString(GALogger.CATEGORY_ACTION, "com.google.android.gms.measurement.UPLOAD");
