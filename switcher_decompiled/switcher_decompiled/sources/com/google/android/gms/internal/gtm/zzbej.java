...
final class zzbej extends zzbba implements RandomAccess, zzbfp, zzbha {
    private static final zzbej zza;
    private double[] zzb;
    private int zzc;

    static {
        zzbej zzbejVar = new zzbej(new double[0], 0);
        zza = zzbejVar;
        zzbejVar.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (!(collection instanceof zzbej)) {
            return super.addAll(collection);
        }
        zzbej zzbejVar = (zzbej) collection;
        int i = zzbejVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzbejVar.zzb, 0, this.zzb, this.zzc, zzbejVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzbejVar.zzc) {
            return false;
        }
        double[] dArr = zzbejVar.zzb;
    ...
    public final int hashCode() {
        int iZzc = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZzc = (iZzc * 31) + zzbfq.zzc(Double.doubleToLongBits(this.zzb[i]));
        }
        return iZzc;
    }
    ...
    public final /* bridge */ /* synthetic */ zzbfp zzd(int i) {
        if (i >= this.zzc) {
            return new zzbej(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    private zzbej(double[] dArr, int i) {
        this.zzb = dArr;
        this.zzc = i;
    }
