...
public final class zzee {
    ...
    public final Bundle zzc(Bundle bundle, boolean z) {
        ...
        if (z) {
            return zzbzVar.zzb(BootloaderScanner.TIMEOUT);
        }
        return null;
    }
    ...
    public final List zzp(String str, String str2) {
        ...
        List list = (List) zzbz.zze(zzbzVar.zzb(BootloaderScanner.TIMEOUT), List.class);
    ...
    public final Map zzq(String str, String str2, boolean z) {
        ...
        Bundle bundleZzb = zzbzVar.zzb(BootloaderScanner.TIMEOUT);
