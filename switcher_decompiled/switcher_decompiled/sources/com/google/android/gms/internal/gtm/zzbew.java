...
final class zzbew extends zzbba implements RandomAccess, zzbfk, zzbha {
    private static final zzbew zza;
    private float[] zzb;
    private int zzc;

    static {
        zzbew zzbewVar = new zzbew(new float[0], 0);
        zza = zzbewVar;
        zzbewVar.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (!(collection instanceof zzbew)) {
            return super.addAll(collection);
        }
        zzbew zzbewVar = (zzbew) collection;
        int i = zzbewVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzbewVar.zzb, 0, this.zzb, this.zzc, zzbewVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzbewVar.zzc) {
            return false;
        }
        float[] fArr = zzbewVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzbfp zzd(int i) {
        if (i >= this.zzc) {
            return new zzbew(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    private zzbew(float[] fArr, int i) {
        this.zzb = fArr;
        this.zzc = i;
    }
