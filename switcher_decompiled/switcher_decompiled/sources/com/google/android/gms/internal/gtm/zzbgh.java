...
final class zzbgh extends zzbba implements RandomAccess, zzbfo, zzbha {
    ...
    public final int hashCode() {
        int iZzc = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZzc = (iZzc * 31) + zzbfq.zzc(this.zzb[i]);
        }
        return iZzc;
    }
    ...
    public final /* bridge */ /* synthetic */ zzbfp zzd(int i) {
        if (i >= this.zzc) {
            return new zzbgh(Arrays.copyOf(this.zzb, i), this.zzc);
        }
