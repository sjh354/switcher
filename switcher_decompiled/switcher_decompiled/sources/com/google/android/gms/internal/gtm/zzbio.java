...
final class zzbio {
    ...
    static String zzd(byte[] bArr, int i, int i2) throws zzbfs {
        ...
        while (i < i3) {
            ...
            if (zzbik.zzd(b2)) {
                ...
                int i7 = i5 + 1;
                zzbik.zzb(b2, bArr[i5], bArr[i7], cArr, i4);
                i = i7 + 1;
                i4++;
            } else {
                if (i5 >= i3 - 2) {
                ...
                int i8 = i5 + 1;
                int i9 = i8 + 1;
                zzbik.zza(b2, bArr[i5], bArr[i8], bArr[i9], cArr, i4);
                i4 += 2;
                i = i9 + 1;
            }
        }
