...
public enum zztq implements zzbfh {
    UNKNOWN(0),
    ANDROID_ALLO(14),
    ANDROID_AUTO(4),
    ...
    private static final zzbfi zzah = new zzbfi() { // from class: com.google.android.gms.internal.gtm.zzto
    ...
    public final String toString() {
        return Integer.toString(this.zzaj);
    }
