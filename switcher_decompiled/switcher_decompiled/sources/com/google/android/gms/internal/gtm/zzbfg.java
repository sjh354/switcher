...
final class zzbfg extends zzbba implements RandomAccess, zzbfl, zzbha {
    ...
    public final zzbfl zzd(int i) {
        if (i >= this.zzc) {
            return new zzbfg(Arrays.copyOf(this.zzb, i), this.zzc);
        }
