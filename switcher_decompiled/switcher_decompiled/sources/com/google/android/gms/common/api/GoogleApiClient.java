    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api<?> api2 : this.zaj.keySet()) {
                ...
                Api.Client clientBuildClient = abstractClientBuilder.buildClient(this.zai, this.zan, clientSettingsZaa, apiOptions, (ConnectionCallbacks) zatVar, (OnConnectionFailedListener) zatVar);
