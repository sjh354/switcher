...
public class CheckerBLEService {
    private BluetoothGatt gatt;
    private CheckerCharacteristicStorage storage;
    private String TAG = "CheckerBLEService";
    private CharacteristicParser parser = new CharacteristicParser();

    public void setBluetoothGatt(BluetoothGatt bluetoothGatt) {
        this.gatt = bluetoothGatt;
        this.storage = new CheckerCharacteristicStorage(bluetoothGatt);
    }
    ...
    public void writeAccessToken(String str, CharacteristicParser.WriteServiceListener writeServiceListener) {
        writeService(str, this.storage.getAccessTokenCharacteristic(), writeServiceListener);
    }
