...
public class FCMService extends FirebaseMessagingService {
    ...
    public void onNewToken(String str) {
        ...
        RestSwitcherAPIStore.requestPostFCMMobileDevices(str, new HttpResponseHandler() { // from class: kr.switcher.switcherm.common.fcm.FCMService.1
            ...
            public void onSuccess(HttpAPIResponse httpAPIResponse) {
                IOLog.i(FCMService.TAG, "Updating token to server was success");
            }

            @Override // kr.switcher.switcherm.network.http.response.HttpResponseHandler
            public void onFailure(String str2, String str3) {
                IOLog.i(FCMService.TAG, "Updating token to server was failed");
            }
        });
