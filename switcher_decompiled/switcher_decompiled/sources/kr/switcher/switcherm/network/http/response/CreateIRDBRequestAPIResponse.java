...
public class CreateIRDBRequestAPIResponse extends HttpAPIResponse {
    ...
    public Callback<CreateIRDBRequestAPIResponse> response(HttpResponseHandler httpResponseHandler) {
