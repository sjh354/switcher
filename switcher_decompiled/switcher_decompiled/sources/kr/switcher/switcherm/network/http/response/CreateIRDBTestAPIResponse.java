...
public class CreateIRDBTestAPIResponse extends HttpAPIResponse {
    ...
    public Callback<CreateIRDBTestAPIResponse> response(HttpResponseHandler httpResponseHandler) {
