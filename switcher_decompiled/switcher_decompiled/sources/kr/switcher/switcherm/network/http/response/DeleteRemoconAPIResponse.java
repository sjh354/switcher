...
public class DeleteRemoconAPIResponse extends HttpAPIResponse {
    @Override // kr.switcher.switcherm.network.http.response.HttpAPIResponse
    public Callback<DeleteRemoconAPIResponse> response(HttpResponseHandler httpResponseHandler) {
