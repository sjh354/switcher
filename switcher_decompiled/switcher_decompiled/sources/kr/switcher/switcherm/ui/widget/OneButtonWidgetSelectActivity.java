...
import kr.switcher.switcherm.ui.widget.presenter.OneButtonWidgetSelectPresenter;
import kr.switcher.switcherm.ui.widget.view.OneButtonWidgetSelectView;

/* JADX INFO: loaded from: classes2.dex */
public class OneButtonWidgetSelectActivity extends AppCompatActivity implements OneButtonWidgetSelectView, WidgetAdapter.OnItemClickListener, FindSwitcherForWidgetInteractor.OnFoundSwitcherForWidgetListener {
    private static final String TAG = "OneButtonWidgetSelectActivity";
    private AppWidgetManager appWidgetManager;
    private OneButtonWidgetSelectPresenter presenter;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_one_button_widget_select);
        ...
        this.remoteView = new RemoteViews(getPackageName(), R.layout.widget_one_button);
        IOUtil.initialize(this);
        setPresenter(new OneButtonWidgetSelectPresenter(this, new FindSwitcherForWidgetInteractor(this)));
    }
    ...
    public void setPresenter(OneButtonWidgetSelectPresenter oneButtonWidgetSelectPresenter) {
        this.presenter = oneButtonWidgetSelectPresenter;
    }

    @Override // kr.switcher.switcherm.ui.widget.view.OneButtonWidgetSelectView
    public void setRecyclerView(List<IODeviceItem> list) {
        WidgetAdapter widgetAdapter = new WidgetAdapter(list, this, WidgetIdFinder.getExistedOneButtonWidgetIds(this));
