...
public class FreeTrialPresent implements FindSwitcherInfoInteractor.OnGetSwitcherInfoListener {
    private FindSwitcherInfoInteractor interactor;
    private LeaseFreeView view;

    public FreeTrialPresent(LeaseFreeView leaseFreeView, FindSwitcherInfoInteractor findSwitcherInfoInteractor) {
        this.view = leaseFreeView;
    ...
    public void onResume(IODevice iODevice) {
        ...
        this.view.setFirstPaymentAt(iODevice.getOption().getPaymentInfo().getNextPayAt());
