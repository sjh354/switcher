...
public class CheckerSurveillanceInfo {
    ...
    public CheckerSurveillanceInfo(String str, View view, View view2, View view3, View view4, View view5, View view6, View view7, AbstractWheel abstractWheel, AbstractWheel abstractWheel2, AbstractWheel abstractWheel3, AbstractWheel abstractWheel4) {
        this.title = str;
        this.mon = view;
        this.tue = view2;
        this.wed = view3;
