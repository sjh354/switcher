...
public class StrokeLevelIconFragment extends Fragment {
    ...
    public static StrokeLevelIconFragment newInstance(int i, PageHashMap pageHashMap2) {
        StrokeLevelIconFragment strokeLevelIconFragment = new StrokeLevelIconFragment();
        Bundle bundle = new Bundle();
        bundle.putInt(PARM_POSITION, i);
        strokeLevelIconFragment.setArguments(bundle);
        pageHashMap = pageHashMap2;
        return strokeLevelIconFragment;
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View viewInflate = layoutInflater.inflate(R.layout.fragment_stroke_level_page, viewGroup, false);
