...
public class AirconReservationListPresenter {
    private static final String TAG = "AirconReservationListPresenter";
    ...
    private AirconReservationListView view;

    public AirconReservationListPresenter(AirconReservationListView airconReservationListView, AirconReservationListInteractor airconReservationListInteractor, DeleteReservationInteractor deleteReservationInteractor, SendReservationToServerInteractor sendReservationToServerInteractor) {
        this.view = airconReservationListView;
    ...
    public void onItemClick(boolean z, int i) {
        ...
        this.view.moveAirconReservationFragment(i);
    }
    ...
    private String getAmpm(String str) {
        return Integer.parseInt(str.substring(7, 9)) < 12 ? IODeviceConfig.AM : "pm";
    }
