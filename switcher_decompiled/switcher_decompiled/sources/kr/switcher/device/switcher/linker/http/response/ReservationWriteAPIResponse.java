...
public class ReservationWriteAPIResponse extends HttpAPIResponse {
    public String command_id;
    public String created_at;

    @Override // kr.switcher.device.switcher.linker.http.response.HttpAPIResponse
    public Callback<ReservationWriteAPIResponse> response(HttpResponseHandler httpResponseHandler) {
