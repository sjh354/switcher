...
public final class UStringsKt {
    ...
    public static final String m1459toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1461toStringolVBNx4(short s, int i) {
    ...
    public static final String m1460toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1458toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m243constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m161boximpl(UByte.m167constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m243constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m421boximpl(UShort.m427constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM496uintDivideJ1ME1BU = 119304647;
        while (i3 < length) {
            int iDigitOf = CharsKt.digitOf(str.charAt(i3), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.uintCompare(i2, iM496uintDivideJ1ME1BU) > 0) {
                if (iM496uintDivideJ1ME1BU == 119304647) {
                    iM496uintDivideJ1ME1BU = UnsignedKt.m496uintDivideJ1ME1BU(-1, iM243constructorimpl);
                    if (UnsignedKt.uintCompare(i2, iM496uintDivideJ1ME1BU) > 0) {
                    }
                }
                return null;
            }
            int iM243constructorimpl2 = UInt.m243constructorimpl(i2 * iM243constructorimpl);
            int iM243constructorimpl3 = UInt.m243constructorimpl(UInt.m243constructorimpl(iDigitOf) + iM243constructorimpl2);
            if (UnsignedKt.uintCompare(iM243constructorimpl3, iM243constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = iM243constructorimpl3;
        }
        return UInt.m237boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM321constructorimpl = ULong.m321constructorimpl(i);
        long j2 = 0;
        long jM498ulongDivideeb3DHEI = 512409557603043100L;
        while (i2 < length) {
            int iDigitOf = CharsKt.digitOf(str.charAt(i2), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.ulongCompare(j2, jM498ulongDivideeb3DHEI) > 0) {
                if (jM498ulongDivideeb3DHEI == 512409557603043100L) {
                    jM498ulongDivideeb3DHEI = UnsignedKt.m498ulongDivideeb3DHEI(j, jM321constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, jM498ulongDivideeb3DHEI) > 0) {
                    }
                }
                return null;
            }
            long jM321constructorimpl2 = ULong.m321constructorimpl(j2 * jM321constructorimpl);
            long jM321constructorimpl3 = ULong.m321constructorimpl(ULong.m321constructorimpl(((long) UInt.m243constructorimpl(iDigitOf)) & 4294967295L) + jM321constructorimpl2);
            if (UnsignedKt.ulongCompare(jM321constructorimpl3, jM321constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = jM321constructorimpl3;
            j = -1;
        }
        return ULong.m315boximpl(j2);
    }
}
