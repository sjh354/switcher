...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1622copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1624copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1624copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1475equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1498hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1519toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m1625getDurationUwyO8pc() {
        return this.duration;
    }
