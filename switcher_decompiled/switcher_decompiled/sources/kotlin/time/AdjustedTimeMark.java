...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1462elapsedNowUwyO8pc() {
        return Duration.m1505minusLRDsOJo(this.mark.mo1462elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1464plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1506plusLRDsOJo(this.adjustment, duration), null);
    }
}
