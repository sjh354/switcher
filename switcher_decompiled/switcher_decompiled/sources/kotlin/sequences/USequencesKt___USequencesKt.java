...
class USequencesKt___USequencesKt {
    public static final int sumOfUInt(Sequence<UInt> sequence) {
        ...
        int iM243constructorimpl = 0;
        while (it.hasNext()) {
            iM243constructorimpl = UInt.m243constructorimpl(iM243constructorimpl + it.next().getData());
        }
        return iM243constructorimpl;
    }

    public static final long sumOfULong(Sequence<ULong> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Iterator<ULong> it = sequence.iterator();
        long jM321constructorimpl = 0;
        while (it.hasNext()) {
            jM321constructorimpl = ULong.m321constructorimpl(jM321constructorimpl + it.next().getData());
        }
        return jM321constructorimpl;
    }
    ...
    public static final int sumOfUByte(Sequence<UByte> sequence) {
        ...
        int iM243constructorimpl = 0;
        while (it.hasNext()) {
            iM243constructorimpl = UInt.m243constructorimpl(iM243constructorimpl + UInt.m243constructorimpl(it.next().getData() & UByte.MAX_VALUE));
        }
        return iM243constructorimpl;
    }
    ...
    public static final int sumOfUShort(Sequence<UShort> sequence) {
        ...
        int iM243constructorimpl = 0;
        while (it.hasNext()) {
            iM243constructorimpl = UInt.m243constructorimpl(iM243constructorimpl + UInt.m243constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM243constructorimpl;
    }
}
