...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static int[] m297constructorimpl(int[] storage) {
    ...
    public boolean m309addWZ4Q5Ns(int i) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean equals(Object obj) {
        return m300equalsimpl(this.storage, obj);
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int[] m296constructorimpl(int i) {
        return m297constructorimpl(new int[i]);
    }

    /* JADX INFO: renamed from: get-pVg5ArA, reason: not valid java name */
    public static final int m302getpVg5ArA(int[] iArr, int i) {
        return UInt.m243constructorimpl(iArr[i]);
    }

    /* JADX INFO: renamed from: set-VXSXFK8, reason: not valid java name */
    public static final void m307setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }
    ...
    /* JADX INFO: compiled from: UIntArray.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010(\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0015\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\t\u0010\b\u001a\u00020\tH\u0096\u0002J\u0016\u0010\n\u001a\u00020\u0002H\u0096\u0002ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u000b\u0010\fR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000ø\u0001\u0001\u0082\u0002\b\n\u0002\b!\n\u0002\b\u0019¨\u0006\r"}, d2 = {"Lkotlin/UIntArray$Iterator;", "", "Lkotlin/UInt;", "array", "", "([I)V", FirebaseAnalytics.Param.INDEX, "", "hasNext", "", "next", "next-pVg5ArA", "()I", "kotlin-stdlib"}, k = 1, mv = {1, 7, 1}, xi = 48)
    private static final class Iterator implements java.util.Iterator<UInt>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UInt next() {
            return UInt.m237boximpl(m312nextpVg5ArA());
        }
    ...
    public boolean m310containsWZ4Q5Ns(int i) {
        return m298containsWZ4Q5Ns(this.storage, i);
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public static boolean m298containsWZ4Q5Ns(int[] iArr, int i) {
    ...
    public static boolean m299containsAllimpl(int[] iArr, Collection<UInt> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
