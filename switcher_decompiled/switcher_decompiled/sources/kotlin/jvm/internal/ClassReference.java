...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
            ...
            if (!jClass.isAnonymousClass()) {
                if (jClass.isLocalClass()) {
                    ...
                    if (enclosingMethod != null) {
                        ...
                        String strSubstringAfter$default = StringsKt.substringAfter$default(name, enclosingMethod.getName() + Typography.dollar, (String) null, 2, (Object) null);
    ...
    static {
        ...
        map.put(GALogger.ACTION_FINGER_LENGTH_SHORT, "kotlin.Short");
        map.put("int", "kotlin.Int");
        map.put("float", "kotlin.Float");
        map.put(GALogger.ACTION_FINGER_LENGTH_LONG, "kotlin.Long");
