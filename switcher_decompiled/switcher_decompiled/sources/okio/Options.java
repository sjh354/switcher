...
public final class Options extends AbstractList<ByteString> implements RandomAccess {
    ...
    public static final class Companion {
        ...
        */
        public final okio.Options of(okio.ByteString... r19) throws java.io.IOException {
            /*
        ...
        private final void buildTrieRecursive(long nodeOffset, Buffer node, int byteStringOffset, List<? extends ByteString> byteStrings, int fromIndex, int toIndex, List<Integer> indexes) throws IOException {
            ...
            if (byteString.getByte(i5) != byteString2.getByte(i5)) {
                ...
                long intCount = nodeOffset + getIntCount(node) + ((long) 2) + ((long) (i8 * 2));
                node.writeInt(i8);
                node.writeInt(i2);
            ...
            long intCount2 = nodeOffset + getIntCount(node) + ((long) 2) + ((long) i13) + 1;
            node.writeInt(-i13);
            node.writeInt(i2);
            int i15 = i5 + i13;
            while (i5 < i15) {
