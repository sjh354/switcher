...
public final class CursorUtil {
    ...
    public static final Cursor copyAndClose(Cursor c) {
        ...
        if (Build.VERSION.SDK_INT <= 15) {
            ...
            try {
                Cursor cursor2 = cursor;
                matrixCursor = new MatrixCursor(cursor2.getColumnNames(), cursor2.getCount());
                while (cursor2.moveToNext()) {
                    Object[] objArr2 = new Object[cursor2.getColumnCount()];
                    ...
                    for (int i2 = 0; i2 < columnCount2; i2++) {
                        ...
                        if (type2 == 0) {
                            ...
                            objArr2[i2] = Long.valueOf(cursor2.getLong(i2));
                        } else if (type2 == 2) {
                            objArr2[i2] = Double.valueOf(cursor2.getDouble(i2));
                        } else if (type2 == 3) {
                            objArr2[i2] = cursor2.getString(i2);
                        } else if (type2 == 4) {
                            objArr2[i2] = cursor2.getBlob(i2);
                        } else {
                            throw new IllegalStateException();
                        }
                    }
