...
public final class FtsTableInfo {
    ...
    public static final class Companion {
        ...
        private final Set<String> readOptions(SupportSQLiteDatabase database, String tableName) {
            ...
            if (Build.VERSION.SDK_INT <= 15) {
                try {
                    sql = cursorQuery.moveToFirst() ? cursorQuery.getString(cursorQuery.getColumnIndexOrThrow("sql")) : "";
                } finally {
                    cursorQuery.close();
                }
            } else {
                ...
                try {
                    Cursor cursor2 = cursor;
                    sql = cursor2.moveToFirst() ? cursor2.getString(cursor2.getColumnIndexOrThrow("sql")) : "";
                    CloseableKt.closeFinally(cursor, null);
                } finally {
                }
            }
