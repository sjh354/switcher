...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo49clone = transition.mo49clone();
        transitionMo49clone.setSceneRoot(sceneRoot);
        Scene currentScene = Scene.getCurrentScene(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo49clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo49clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo49clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo49clone = transition.mo49clone();
        sceneChangeSetup(viewGroup, transitionMo49clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo49clone);
    }
