...
final class ContinuationConsumer<T> extends AtomicBoolean implements Consumer<T> {
    ...
    public void accept(T value) {
        if (compareAndSet(false, true)) {
            ...
            continuation.resumeWith(Result.m149constructorimpl(value));
        }
    }
