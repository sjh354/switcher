...
public final class InlineList<E> {
    ...
    public static String m1688toStringimpl(Object obj) {
        return "InlineList(holder=" + obj + ')';
    }

    public boolean equals(Object obj) {
        return m1683equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1686hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1688toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1682constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1681constructorimpl(obj);
    }

    /* JADX INFO: renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m1687plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m1681constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m1681constructorimpl(arrayList);
    }

    /* JADX INFO: renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m1685forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
