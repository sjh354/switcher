...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1692scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1692scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
    ...
    public void mo1691dispatch(CoroutineContext context, Runnable block) {
        if (!addAndTryDispatching(block) && tryAllocateWorker()) {
            this.dispatcher.mo1691dispatch(this, this);
        }
    }
