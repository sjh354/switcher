...
public interface SendChannel<E> {
    ...
    Object mo1646trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1661isSuccessimpl(objMo1646trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1655exceptionOrNullimpl = ChannelResult.m1655exceptionOrNullimpl(objMo1646trySendJP2dKIU);
