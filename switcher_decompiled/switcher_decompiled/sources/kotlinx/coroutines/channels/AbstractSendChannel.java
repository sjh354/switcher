...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object mo1646trySendJP2dKIU(E element) {
        Object objOfferInternal = offerInternal(element);
        if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m1666successJP2dKIU(Unit.INSTANCE);
        }
        if (objOfferInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m1665failurePtdJZtk() : ChannelResult.INSTANCE.m1664closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m1664closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m149constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m149constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    */
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo1690remove()) {
                receive.helpRemove();
            } else {
                objM1682constructorimpl$default = InlineList.m1687plusFjFbRPM(objM1682constructorimpl$default, receive);
            }
        }
        if (objM1682constructorimpl$default != null) {
            if (!(objM1682constructorimpl$default instanceof ArrayList)) {
                ((Receive) objM1682constructorimpl$default).resumeReceiveClosed(closed);
            } else if (objM1682constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) objM1682constructorimpl$default;
    ...
    */
    public final java.lang.Object sendSuspend(E r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L59:
            ...
            java.lang.Object r5 = kotlin.Result.m149constructorimpl(r5)
            r1.resumeWith(r5)
            goto L7f
        L6f:
