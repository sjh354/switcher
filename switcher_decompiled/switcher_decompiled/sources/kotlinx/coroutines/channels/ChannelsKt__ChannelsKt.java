...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM149constructorimpl = Result.m149constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM149constructorimpl = Result.m149constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1651boximpl(Result.m156isSuccessimpl(objM149constructorimpl) ? ChannelResult.INSTANCE.m1666successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1664closedJP2dKIU(Result.m152exceptionOrNullimpl(objM149constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1646trySendJP2dKIU = sendChannel.mo1646trySendJP2dKIU(e);
        if (objMo1646trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1661isSuccessimpl(sendChannel.mo1646trySendJP2dKIU(e))) {
            return;
        }
