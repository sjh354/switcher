...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1692scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1628delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1629toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1629toDelayMillisLRDsOJo(long j) {
        if (Duration.m1469compareToLRDsOJo(j, Duration.INSTANCE.m1572getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1488getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
