...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    */
    ...
    public boolean tryEmit(T value) {
        ...
        while (i < length) {
            ...
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m149constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    public final Continuation<Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long oldIndex) {
        ...
        if (getNCollectors() > 0) {
            iMin = Math.min(this.queueSize, this.bufferCapacity - ((int) (bufferEndIndex - j2)));
        } else {
            iMin = this.queueSize;
        }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryEmitLocked(t)) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m149constructorimpl(Unit.INSTANCE));
        ...
        while (i < length) {
            ...
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m149constructorimpl(Unit.INSTANCE));
            }
        }
