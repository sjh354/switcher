...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM149constructorimpl = Result.m149constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM149constructorimpl = Result.m149constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m155isFailureimpl(objM149constructorimpl) ? null : objM149constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1668installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1668installSignalHandler$lambda1(Signal signal) {
