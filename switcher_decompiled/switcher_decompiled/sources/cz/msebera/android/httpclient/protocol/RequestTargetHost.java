...
public class RequestTargetHost implements HttpRequestInterceptor {
    ...
    public void process(HttpRequest httpRequest, HttpContext httpContext) throws HttpException, IOException {
        ...
        if ((httpRequest.getRequestLine().getMethod().equalsIgnoreCase(IOLog.DEVICE_LOG_TYPE_CONNECT) && protocolVersion.lessEquals(HttpVersion.HTTP_1_0)) || httpRequest.containsHeader("Host")) {
            return;
        }
