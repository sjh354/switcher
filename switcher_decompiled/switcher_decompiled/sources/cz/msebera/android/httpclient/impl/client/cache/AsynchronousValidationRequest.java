    ...
    */
    private boolean revalidateCacheEntry() {
        /*
            r7 = this;
            r0 = 0
            cz.msebera.android.httpclient.impl.client.cache.CachingExec r1 = r7.cachingExec     // Catch: java.lang.RuntimeException -> L31 cz.msebera.android.httpclient.HttpException -> L4b java.io.IOException -> L54
            cz.msebera.android.httpclient.conn.routing.HttpRoute r2 = r7.route     // Catch: java.lang.RuntimeException -> L31 cz.msebera.android.httpclient.HttpException -> L4b java.io.IOException -> L54
            cz.msebera.android.httpclient.client.methods.HttpRequestWrapper r3 = r7.request     // Catch: java.lang.RuntimeException -> L31 cz.msebera.android.httpclient.HttpException -> L4b java.io.IOException -> L54
            cz.msebera.android.httpclient.client.protocol.HttpClientContext r4 = r7.context     // Catch: java.lang.RuntimeException -> L31 cz.msebera.android.httpclient.HttpException -> L4b java.io.IOException -> L54
            cz.msebera.android.httpclient.client.methods.HttpExecutionAware r5 = r7.execAware     // Catch: java.lang.RuntimeException -> L31 cz.msebera.android.httpclient.HttpException -> L4b java.io.IOException -> L54
            cz.msebera.android.httpclient.client.cache.HttpCacheEntry r6 = r7.cacheEntry     // Catch: java.lang.RuntimeException -> L31 cz.msebera.android.httpclient.HttpException -> L4b java.io.IOException -> L54
            cz.msebera.android.httpclient.client.methods.CloseableHttpResponse r1 = r1.revalidateCacheEntry(r2, r3, r4, r5, r6)     // Catch: java.lang.RuntimeException -> L31 cz.msebera.android.httpclient.HttpException -> L4b java.io.IOException -> L54
        ...
        L27:
            r2 = r0
        L28:
            r1.close()     // Catch: java.lang.RuntimeException -> L31 cz.msebera.android.httpclient.HttpException -> L4b java.io.IOException -> L54
            return r2
        L2c:
            r2 = move-exception
            r1.close()     // Catch: java.lang.RuntimeException -> L31 cz.msebera.android.httpclient.HttpException -> L4b java.io.IOException -> L54
            throw r2     // Catch: java.lang.RuntimeException -> L31 cz.msebera.android.httpclient.HttpException -> L4b java.io.IOException -> L54
        L31:
            r1 = move-exception
