...
class ResponseCachingPolicy {
    ...
    private static final Set<Integer> cacheableStatuses = new HashSet(Arrays.asList(200, 203, Integer.valueOf(HttpStatus.SC_MULTIPLE_CHOICES), 301, 410));
    ...
    public ResponseCachingPolicy(long j, boolean z, boolean z2, boolean z3) {
        ...
        if (z3) {
            ...
            this.uncacheableStatuses = new HashSet(Arrays.asList(numValueOf, 303));
        }
    }
