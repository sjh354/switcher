...
public class CachingExec implements ClientExecChain {
    ...
    boolean clientRequestsOurOptions(HttpRequest httpRequest) {
        ...
        return "OPTIONS".equals(requestLine.getMethod()) && "*".equals(requestLine.getUri()) && Switcher.SwitcherReservation.SWITCH_1WAY_FIRMWARE.equals(httpRequest.getFirstHeader("Max-Forwards").getValue());
    }
