...
public final class Handshake {
    ...
    public final List<Certificate> m1748deprecated_peerCertificates() {
    ...
    public final Principal m1749deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m1746deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m1747deprecated_localPrincipal() {
    ...
    public String toString() {
        ...
        StringBuilder sbAppend = new StringBuilder().append("Handshake{").append("tlsVersion=").append(this.tlsVersion).append(TokenParser.SP).append("cipherSuite=").append(this.cipherSuite).append(TokenParser.SP).append("peerCertificates=").append(arrayList.toString()).append(TokenParser.SP).append("localCertificates=");
    ...
    public static final class Companion {
        ...
        public final Handshake m1751deprecated_get(SSLSession sslSession) throws IOException {
