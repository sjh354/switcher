...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    /* JADX INFO: compiled from: HttpLoggingInterceptor.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\bæ\u0080\u0001\u0018\u0000 \u00062\u00020\u0001:\u0001\u0006J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0007"}, d2 = {"Lokhttp3/logging/HttpLoggingInterceptor$Logger;", "", "log", "", NotificationChannelUtil.Channel.MESSAGE, "", "Companion", "okhttp-logging-interceptor"}, k = 1, mv = {1, 4, 0})
    public interface Logger {
        ...
        public static final class Companion {
            ...
            /* JADX INFO: compiled from: HttpLoggingInterceptor.kt */
            @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0016¨\u0006\u0007"}, d2 = {"Lokhttp3/logging/HttpLoggingInterceptor$Logger$Companion$DefaultLogger;", "Lokhttp3/logging/HttpLoggingInterceptor$Logger;", "()V", "log", "", NotificationChannelUtil.Channel.MESSAGE, "", "okhttp-logging-interceptor"}, k = 1, mv = {1, 4, 0})
    ...
    public Response intercept(Interceptor.Chain chain) throws Exception {
        ...
        String str2 = "--> " + request.method() + TokenParser.SP + request.url() + (connection != null ? " " + connection.protocol() : "");
        ...
        try {
            ...
            StringBuilder sbAppend = new StringBuilder().append("<-- ").append(responseProceed.code());
            if (responseProceed.message().length() == 0) {
                ...
                str = "-byte body omitted)";
                c = TokenParser.SP;
                string = sb.append(String.valueOf(TokenParser.SP)).append(strMessage).toString();
            }
            logger.log(sbAppend.append(string).append(c).append(responseProceed.request().url()).append(" (").append(millis).append("ms").append(!z2 ? ", " + str3 + " body" : "").append(')').toString());
            if (z2) {
                ...
                if (!z || !HttpHeaders.promisesBody(responseProceed)) {
                    ...
                    Long l = null;
                    if (StringsKt.equals(AsyncHttpClient.ENCODING_GZIP, headers2.get("Content-Encoding"), true)) {
    ...
    private final boolean bodyHasUnknownEncoding(Headers headers) {
        ...
        return (str == null || StringsKt.equals(str, HTTP.IDENTITY_CODING, true) || StringsKt.equals(str, AsyncHttpClient.ENCODING_GZIP, true)) ? false : true;
    }
}
