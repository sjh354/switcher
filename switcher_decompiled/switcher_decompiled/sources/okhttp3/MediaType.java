...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType get(String toMediaType) {
            ...
            while (iEnd < toMediaType.length()) {
                ...
                if (!matcher2.lookingAt()) {
                    ...
                    throw new IllegalArgumentException(sbAppend.append(strSubstring).append("\" for: \"").append(toMediaType).append('\"').toString().toString());
                }
        ...
        public final MediaType m1780deprecated_get(String mediaType) {
        ...
        public final MediaType m1781deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
