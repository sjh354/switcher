...
public final class CacheInterceptor implements Interceptor {
    ...
    public static final class Companion {
        ...
        private final boolean isEndToEnd(String fieldName) {
            return (StringsKt.equals("Connection", fieldName, true) || StringsKt.equals(HTTP.CONN_KEEP_ALIVE, fieldName, true) || StringsKt.equals("Proxy-Authenticate", fieldName, true) || StringsKt.equals("Proxy-Authorization", fieldName, true) || StringsKt.equals(cz.msebera.android.httpclient.HttpHeaders.TE, fieldName, true) || StringsKt.equals("Trailers", fieldName, true) || StringsKt.equals("Transfer-Encoding", fieldName, true) || StringsKt.equals(cz.msebera.android.httpclient.HttpHeaders.UPGRADE, fieldName, true)) ? false : true;
        }
