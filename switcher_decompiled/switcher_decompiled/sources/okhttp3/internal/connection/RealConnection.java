...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARN: Removed duplicated region for block: B:75:0x0170 A[EDGE_INSN: B:75:0x0170->B:61:0x0170 BREAK  A[LOOP:0: B:67:0x00a8->B:77:?], SYNTHETIC] */
    /*
    ...
    */
    ...
    private final Request createTunnelRequest() throws IOException {
        Request requestBuild = new Request.Builder().url(this.route.address().url()).method(IOLog.DEVICE_LOG_TYPE_CONNECT, null).header("Host", Util.toHostHeader(this.route.address().url(), true)).header("Proxy-Connection", HTTP.CONN_KEEP_ALIVE).header("User-Agent", Util.userAgent).build();
