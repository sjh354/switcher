...
public final class Response implements Closeable {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = DBPricingModelDAO.COLUMN_CODE, imports = {}))
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = NotificationChannelUtil.Channel.MESSAGE, imports = {}))
    ...
    public final CacheControl m1822deprecated_cacheControl() {
        return cacheControl();
    }
